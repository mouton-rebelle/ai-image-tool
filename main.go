...
func main() {
	...
	if *help {
		...
		fmt.Println("")
		fmt.Println("Prompt Generation Configuration:")
		fmt.Println("  PROMPT_LLM_API_KEY                           # Provider API key (falls back to XAI_API_KEY)")
		fmt.Println("  PROMPT_LLM_BASE_URL                          # OpenAI-compatible base URL (default: https://api.x.ai/v1)")
		fmt.Println("  PROMPT_LLM_MODEL                             # Chat model (default: grok-4.5)")
		fmt.Println("  PROMPT_LLM_REASONING_EFFORT                  # Reasoning level (default: medium)")
		fmt.Println("")
